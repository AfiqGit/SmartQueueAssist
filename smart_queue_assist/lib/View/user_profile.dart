                          ...
                          //mainAxisSize: MainAxisSize.min,
                              children: <Widget>[
                                ...
                                TextFormField(
                                  ...
                                  style: TextStyle(color: Color.fromRGBO(191, 122, 105, 1)),
...
void _showProfileUpdatedDialog(BuildContext context) {
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        title: new Text("Successful", style: TextStyle(color: Color.fromRGBO(191, 122, 105, 1), fontSize: 17, fontWeight: FontWeight.bold)),
        content: new Text("Profile Updated", style: TextStyle(color: Color.fromRGBO(191, 122, 105, 1), fontSize: 16, fontWeight: FontWeight.bold)),
        actions: <Widget>[
          new FlatButton(
