                      ...
                      GestureDetector(
                        onTap: ()async{
                          if(_formKey.currentState.validate()){
                            ...
                            dynamic result = await _auth.signUp(_email, _password, fname, lname, idnum);
                            if(result != null){
                              setState(() {
                                loading = false;
...
void _showExistingUserDialog(BuildContext context) {
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        title: new Text("User Already Exists", style: TextStyle(color: Color.fromRGBO(191, 122, 105, 1), fontSize: 15, fontWeight: FontWeight.bold)),
        content: new Text("Please Try Different Email", style: TextStyle(color: Color.fromRGBO(191, 122, 105, 1), fontSize: 14, fontWeight: FontWeight.bold)),
        actions: <Widget>[
          new FlatButton(
            child: new Text("OK", style: TextStyle(color: Color.fromRGBO(191, 122, 105, 1), fontSize: 15, fontWeight: FontWeight.bold)),
            onPressed: () {
